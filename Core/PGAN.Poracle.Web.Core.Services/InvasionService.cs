...
public class InvasionService : IInvasionService
{
    private readonly IInvasionRepository _repository;

    public InvasionService(IInvasionRepository repository)
    {
    ...
    public async Task<Invasion?> GetByUidAsync(int uid)
    {
